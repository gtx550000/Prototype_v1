...
const profile =()=>
{
    const notify = () =>toast.success('😉 Wow so easy!', {position: "bottom-right",autoClose: 3000,});
    const notify1 = () =>toast.error('😨 Sorry bro', {position: "bottom-right",autoClose: 3000,});
  ...
  return (
    ...
    <div className="container light-style flex-grow-1 container-p-y">
        ...
        <div className="text-right mt-3">
            ...
            <button type="button" className="btn btn-primary" onClick={notify}>Save changes</button>&nbsp;
            <button type="button" className="btn btn-default" onClick={notify1}>Cancel</button>
            <ToastContainer />
        </div>
